...
%                          3 &=& partNumber is a dummy part number representing a SET 
%                              of selective features or building blocks. 
%                              This part number is created
%                              solely for the WIT interface and may or may not
%                              exist within EPPS.  However, the name assigned
%                              to this part must be unique to the MachineType and 
%                              Geography to which the feature percentages will
%                              pertain.  The name should also be ``meaningful''
%                              (eg, HardFile\_NOBEL\_LA means: Building Block
%                              category is ``HardFile'',  MachineType is ``NOBEL'',
%                              and the Geography is ``LA'').
    \end{tabular}
\end{tabular}
...
remove\_flag    &   boolean  &  TRUE indicates bill is a ``remove'' bill.
                             ...
                             record;  default $=$ 0 \\
%mand\_opt\_flag  &   boolean  &  TRUE indicates that the child is a
%                             mandatory part in the parents BOM.
%                             FALSE indicates that the child is an
%                             optional part in the parent's bill.  \\
%option\_ratio   &   float    &  (Only relevant when mand\_opt\_flag = FALSE)
%                             Option ratio.  In implosion, this ratio
...
%                             the child. \\
%max\_ratio\_without & float   &   Only relevant when mand\_opt\_flag = FALSE
%                             In implosion, this ratio multiplied by
...
\multicolumn{4}{c}{{\bf Parameters File (Continued)}}\\ 
     \hline\hline
{\bf ParamID} &  {\bf type}  & {\bf Mand} &  {\bf comment} \\ \hline
% doImplode & boolean & Y & do an implosion; default $=$ 1 \\
...
default $=$ 10. \\
% heurForceEquit & boolean & N & Force heuristic equitability;
% default $=$ 0. \\
