...
//----------------------------------------------------------------
//  Typedefs to facilitate passing WIT functions as function parameters
// ---------------------------------------------------------------
extern "C" {
typedef witReturnCode (STDCALL *witSetNameFloatStar)(
...
extern "C" {
typedef witReturnCode (STDCALL *witGetNameWitBooleanStar)(
    WitRun *const theWitRun,
    const char *const name,
    witBoolean * b);
}
...
extern "C" {
typedef witReturnCode (STDCALL *witGetNameFloatStarStar)(
    WitRun *const theWitRun,
    const char *const name,
    float **floatVec);
}
...
extern "C" {
typedef witReturnCode (STDCALL *witSetName3FloatStar)(
    WitRun *const theWitRun,
...
extern "C" {
typedef witReturnCode (STDCALL *witGetName3FloatStar)(
    WitRun *const theWitRun,
    const char *const operationName,
    float **hardLower,
    float **softLower,
...
extern "C" {
typedef witReturnCode (STDCALL *witSetNameIndexFloatStar)(
    WitRun *const theWitRun,
    const char *const name,
...
extern "C" {
typedef witReturnCode (STDCALL *witSetNameIndexIndexFloatStar)(
    WitRun *const theWitRun,
    const char *const name,
    const int bopEntryIndex,
...
extern "C" {
typedef witReturnCode (STDCALL *witGetNameIndexFloatStarStar)(
    WitRun *const theWitRun,
    const char *const name,
    const int bopEntryIndex,
    float **floatVec);
...
extern "C" {
typedef witReturnCode (STDCALL *witGetNameIndexIntStarStar)(
    WitRun *const theWitRun,
    const char *const name,
    const int bopEntryIndex,
    int **intVec);
...
extern "C" {
typedef witReturnCode (STDCALL *witGetNameIndexIndexFloatStarStar)(
    WitRun *const theWitRun,
    const char *const name,
    const int bopEntryIndex,
    const int subEntryIndex,
...
extern "C" {
typedef witReturnCode (STDCALL *witGetNameIndexIndexIntStarStar)(
    WitRun *const theWitRun,
    const char *const name,
    const int bopEntryIndex,
    const int subEntryIndex,
...
extern "C" {
typedef witReturnCode (STDCALL *witGetNameIndexIndexIntStar)(
    WitRun *const theWitRun,
...
extern "C" {
typedef witReturnCode (STDCALL *witSetDblNameFloatStar)(
    WitRun *const theWitRun,
...
extern "C" {
typedef witReturnCode (STDCALL *witGetDblNameFloatStarStar)(
    WitRun *const theWitRun,
    const char *const partName,
    const char *const demandName,
    float **floatVec);
...
// -----------------------------------------------------
//  Base class to provide access to a WitRun and Wit Functions
//  in a C++ object oriented style
//  It is expected that an application will derive from this class
// -----------------------------------------------
class VISORproblem
{
public:
  ...
  // Set OSL/CPLEX/COIN Logfile name
  void setSolverLogFileName(const std::string &name);

  // write wit data file
  void writeWitData(const std::string &filename);



  // -----------------------------------------------------
  //  Utilities for converting between WIT c datatypes and
  //   C++ datatypes
  // --------------------------------------------------------
...
protected:
  ...
  // Get vector of wit part/Operation witBoolean attribute
  bool witGetNameAttributeBool(
  ...
  //------------------------------------------------
  //  Substitute BOM Set/Get Wrappers
  //-------------------------------------------------
  ...
  //------------------------------------------------
  //  Useful functions not directly provided by WIT
  //-------------------------------------------------

  // Get list of all products produced by an operation
