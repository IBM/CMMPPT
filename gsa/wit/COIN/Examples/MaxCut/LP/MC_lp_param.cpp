...
void BCP_parameter_set<MC_lp_par>::create_keyword_list() {
   ...
   //--------------------------------------------------------------------------
   // CharPar
   keys.push_back(make_pair(BCP_string("MC_DoRestarting"),
...
// 					  )));
   ...
   keys.push_back(make_pair(BCP_string("MC_SolveToOptFreqBeforeBranch"),
			    BCP_parameter(BCP_IntPar,
					  SolveToOptFreqBeforeBranch)));
   //--------------------------------------------------------------------------
...
void BCP_parameter_set<MC_lp_par>::set_default_entries(){
   ...
   set_entry(SolveToOptFreqBeforeBranch, 0);
