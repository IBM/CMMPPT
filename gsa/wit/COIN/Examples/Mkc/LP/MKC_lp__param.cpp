...
// 					  )));
   ...
   //--------------------------------------------------------------------------
   // IntPar
   keys.push_back(make_pair(BCP_string("MKC_LpSolver"),
   ...
   keys.push_back(make_pair(BCP_string("MKC_MaxEnumeratedSize"),
			    BCP_parameter(BCP_IntPar,
					  MaxEnumeratedSize)));
   keys.push_back(make_pair(BCP_string("MKC_MaxEnumeratedCount"),
			    BCP_parameter(BCP_IntPar,
					  MaxEnumeratedCount)));
...
void BCP_parameter_set<MKC_lp_par>::set_default_entries(){
   ...
   //--------------------------------------------------------------------------
   // IntPar
   set_entry(LpSolver, 2); // Volume 1; Clp 2; Osl 4
   set_entry(LpSolverMessageSuppression, 3);
   set_entry(MaxEnumeratedSize, 20);
   set_entry(MaxEnumeratedCount, 50);
