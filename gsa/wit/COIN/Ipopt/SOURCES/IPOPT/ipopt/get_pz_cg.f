...
C
     ...
     2     NLB, ILB, NUB, IUB, S_L, S_U, LSLACKS, SIGMA_L, SIGMA_U,
     1     ERR, ERR_BAR, NEWBAS,
     3     KCONSTR, LRS, RS, LIS, IS, LRW, RW, LIW, IW, IERR)
C
C*******************************************************************************
C
C    $Id: get_pz_cg.f,v 1.2 2002/11/24 21:39:29 andreasw Exp $
C
C-------------------------------------------------------------------------------
C                                 Title
C-------------------------------------------------------------------------------
...
C
      if( LSLACKS ) then
         call C_OUT(2,0,1,'get_pz_cg: LSLACKS???')
         IERR = 4
         goto 9999
      endif
C
...
C
     ...
     1        RW(p_prec+1), .false., KCONSTR, LRS, RS, LIS, IS,
