...
C !DEC$ ATTRIBUTES DLLEXPORT::READ_ENTRY
C
C*******************************************************************************
C
C    $Id: read_entry.f,v 1.1 2002/05/02 18:52:18 andreasw Exp $
C
C-------------------------------------------------------------------------------
C                                 Title
C-------------------------------------------------------------------------------
...
C     and empty lines
 ...
 10   continue
      if( BUFPOS.eq.0 ) then
 20      continue
         read(CNR,'(a)',end=101,err=99) BUFFER
