...
if (`hostname` =~ *.watson.ibm.com || `hostname` == wit) then
  setenv DS_DIR 		/gsa/yktgsa/projects/w/wit/
...
setenv WIT_ROOT_DIR /gsa/yktgsa/projects/w/wit/$USER/wit
setenv SCENARIO_ROOT_DIR /gsa/yktgsa/projects/w/wit/$USER/scenario
